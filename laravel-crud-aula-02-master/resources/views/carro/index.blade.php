...
@section('conteudo')
    ...
    <table class="table align-middle caption-top table-striped">
        <thead>
            ...
            <th class="d-none d-md-table-cell text-secondary">MARCA</th>
            <th class="d-none d-md-table-cell text-secondary">COR</th>
            <th class="d-none d-md-table-cell text-secondary">CLIENTE</th>
        ...
        <tbody>
            @foreach ($data as $item)
                <tr>
                    ...
                    <td class="d-none d-md-table-cell">{{ $item->cliente->nome}}</td>
                    <td>
                        <a href="{{route('disciplina.show', $item->id)}}" class="btn btn-outline-info">
                        ...
                        <a href="{{route('carro.edit', $item->id)}}" class="btn btn-outline-success">
